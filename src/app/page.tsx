...
export default function Home() {
  return (
    <>
      ...
      <section className="max-w-4xl w-full mx-auto py-8 px-2 md:py-16 md:px-4" id="servicos">
        <h2 className="text-xl md:text-2xl font-semibold text-primary mb-6">Nossos Serviços</h2>
